...
class AssemblyParams:
    ...
    # Phase 1: 200m高密度巻き φ80×80mm (d=7, N_col=98, τ₂=980ns)
    # Phase 2+: d≥9 (331m+) は筐体内収容不可 → DWG-006 ラック型PMFモジュール
    ...
    # =====================================================================
    # Zone C: 電子制御 (X=210-294, Y=5-244, Z=5-139)
    # =====================================================================
    ...
    # 290×240×3mm, PMFスプール貫通部にφ85mm切欠き + EMI壁通過スロット(X=210, 幅2mm) + HP通過穴φ8×3箇所[(230,50),(250,125),(230,200)]
    # =====================================================================
    PTFE_SIZE: tuple = (295.5, 241.5, 3.0)    # 溝係合: X=1.5→297, Y=1.5→243
    PTFE_POS: tuple = (1.5, 1.5, 90.0)       # Z=90 底面基準; 溝内縁(X=1.5,Y=1.5)に正確に嵌合
