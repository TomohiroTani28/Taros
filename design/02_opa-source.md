...
| **Phase 2+ (PIC統合, 現実的)** | 13dB | 0.27dB | 0.940 | 0.112 (non-loss込み) | **≈9.5dB** | LNOI PIC + OPA結合損失込み [v3.5: V_eff=0.9397×0.0501+0.0603+0.005=0.1124→9.49dB] |
...
| **Phase 2+ (2033-)** | **LNOI PIC統合** | **σ_gen=13dB, L=0.27dB(現実的) → σ_eff≈9.5dB (製品FTQC)** | PIC内蔵 |
