...
| 消費電力 (WDM込み) | **~100W** | **~109W** | **~112W** | [v3.2: SOA +3W]
| 冷却 | パッシブ+低速ファン(<25dBA) | パッシブ+低速ファン(<25dBA) | パッシブ+低速ファン(<20dBA) |
| 原価 (量産100台, WDM込み)‡ | **$53K** | **$75K** | **$95K** |
| 販売価格 | **$90K** | **$120K** | **$170K** |
...
│                                                                      │
│  ┌──────────────┐  ┌──────────────┐  ┌──────────────┐              │
│  │Balanced PD ×2│  │ADC 14bit     │  │FPGA          │              │
│  │InGaAs        │──│1GSPS ×2      │──│Versal VE2302 │              │
│  │              │  │              │  │              │              │
│  └──────────────┘  └──────────────┘  │ GKP decoder  │              │
│                                       │ Surface code │              │
│  ┌──────────────┐                    │ FF control   │              │
│  │DAC 16bit     │◄───────────────────│ Phase lock   │              │
│  │12GSPS        │                    └──────────────┘              │
│  │→ EO driver   │                                                  │
│  └──────────────┘                                                  │
│                                                                      │
...
- Taros Edu (OPA×1, WDM 5ch): 82W + 8W + 10W(RF修正) = **100W** (OPA×1でPeltier -4W) [v3.2: SOA +3W]
...
- ※旧仕様のUSB-PD 100W代替電源は廃止。Pro/Maxは106W以上のため100W不可。Edu(97W)は100Wでも動作可能だがマージン確保のため140W統一を推奨。
...
| 自然対流のみ | **~49W** (h=8 W/m²K, A_eff=筐体0.14m²+フィン0.33m²×効率0.5×空気滞留0.7=0.26m², 合計≈0.26m², ΔT=25K(表面50℃), Q=8×0.26×25≈**52W**概算、保守49W)。106W放熱にはファン必須。 |
...
| **Taros Edu** | **CV光子** | **~1 (d=3)** | **ラップトップ** | **$90K** | **97W** |
| **Taros Pro** | **CV光子** | **10+ (d=5)** | **ミニPC** | **$120K** | **106W** |
| **Taros Max** | **CV光子** | **100+ (d=7)** | **デスクトップ** | **$170K** | **109W** |
...
| パラメータ | 値 |
|-----------|-----|
| 消費電力 | 89W (WDM 3ch省電力モード、106W基準から-17W) |
| バッテリー | Li-ion 288Wh (ラップトップ用×3) |
| **駆動時間** | **3.2時間** (288Wh÷89W) |
| バッテリー重量 | +2kg |
...
*本文書はCV pure構成（QDなし、完全室温、低速ファン準無音冷却）のポータブル量子コンピュータシリーズを定義したものである。PPLN導波路OPA + macronode TDMの最小構成により、106W・7.5kg・$120Kの誤り訂正型量子コンピュータを実現する。*
