...
>
> **BSモデル公式（正式）**: `V_eff = η × V_sqz + (1 − η) + V_nl`
> - η: 全光学透過率, V_sqz = 10^(−σ_gen/10): スクイーズド分散, V_nl: 非損失ノイズ (0.010 SNU)
> - 旧dB減算公式 σ_eff = σ_gen − L は**廃止**。BSモデルが全文書の正式公式。
>
> **SSOT階層**:
...
|-------|------|---------------|--------------------|--------------------|
| **-1** | 開始後0-12ヶ月 | 約4.6億円, GKP実験+Stim検証 | — | Go/No-Go判定 |
...
| 物理エラー率 | p_phys (=p_err) | 9.3×10⁻³ | ≈4.9×10⁻³ (L=0.27dB) | ≈1.0×10⁻³ | design/13_performance |
