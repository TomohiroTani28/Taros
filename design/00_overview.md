...
| 重量 | **~7.5kg** | 28kg (システム合計51kg†²) | 180kg |
| 消費電力 | **~109W** | 2.1kW | 8kW |
| 冷却 | **不要** | PT205 (8.6kg) + コンプレッサー23kg†² | RDK-415E (75kg) |
| SNSPD | **0個** | ~1,000個 | 3,000個 |
| QD | **0個** | 24個 | 80個 |
| コスト | **約1,800万円** | 約6,480万円 | ~約3億円 |
| スケーラビリティ | **逐次拡張(TDM)†** | 48 max | 42 max |

†²DV v5.0: 本体28kg + コンプレッサー23kg = システム合計51kg。CV方式は外部冷却不要。
...
Phase -1 (開始後0-12ヶ月): タスク費合計約1.7億円 (新規約9,190万円+既存約8,250万円)。人件費込み総額: 約4.6億円
    ...
    └── G-EXP2 (開始後約3ヶ月): パルスGKP P_round>10⁻³ (strict mode)
         │
Phase 0a (開始後約9-12ヶ月): Taros Edu プロトタイプ (d=3, WDM 5ch, ~10kHz) — 約1.8億円
Phase 0b (開始後約15-18ヶ月): Taros Pro プロトタイプ (d=5, WDM 8ch, ~3kHz)
Phase 1  (開始後約2年): Taros Max プロトタイプ (d=7, WDM 7ch, ~1kHz) — 約1.5億円
Phase 2  (開始後約3年): 量産設計 (100台/年) — 約7,500万円
Phase 3  (開始後約4年以降): WDM 20ch フルスペック (60kHz Tゲート)
累計: 約8.7億円 (詳細: analysis/development-cost-summary.md)
```
