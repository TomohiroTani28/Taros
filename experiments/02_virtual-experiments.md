...
| 閾値マージン | Walshe+ 2025 | BSモデル: +3.4dB (Phase 2+ PIC 10.9dB vs 7.5dB postsel閾値)。旧値+4.0dB (11.5dB vs 7.5dB) はdB減算誤りに基づく | 3/5 |
...
sigma = 0.188  # 11.5dB (旧製品基準, AWG込み。BSモデルでは σ_eff=10.9dB Phase 2+ PIC が正しい値)
