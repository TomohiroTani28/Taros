...
> ※費用定義の統一: 装置BOM約560万円 (Phase -1a 480万+Phase -1b 80万, experiments/01参照) /
> 装置直接費約800万円 (予備・消耗品込み) /
> 完全コスト約2,900万円 (人件費2名×5ヶ月込み)。
> 本文書のLevel 2 約585万円はLevel 2独自の見積もり（部品仕様・単価がexperiments/01と一部異なる）。
