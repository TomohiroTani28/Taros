...
| Balanced homodyne detector ×2 | 約30万円 | Thorlabs PDB480C相当 (単価~$3K) |
| ADC (14bit 400MSPS) ×2 | 約60万円 | TI ADS5474 (設計ベースライン400MHz準拠) |
| 光学部品 (BS, ミラー, PBS, λ/2) | 約75万円 | |
| PMF, コネクタ, マウント | 約45万円 | |
| Master laser (1550nm) | 約225万円 | NKT Koheras E15 (experiments/01, analysis/bom準拠) |
| SHG module | 約45万円 | |
| 光学テーブル・マウント (既存流用想定) | 0〜約45万円 | |
| **Level 2 合計** | **約560万円** | **期間: 3ヶ月 (SSOT: experiments/01_gkp-optical.md)** |
