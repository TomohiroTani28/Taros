...
4. **QDなし構成の成立**: pure CV（QD=0）でも Phase 2+ PIC時 p_L≈2-5×10⁻⁵ (MWPM, d=7, L=0.27dB, QE≥99%) → 製品目標(≲10⁻⁵)境界。L≤0.20dBで<10⁻⁵確実達成。理論限界p_L≈5.7×10⁻⁷はL=0.15dB+QE99%+Δ=0の全条件達成時のみ（v3.3修正）
