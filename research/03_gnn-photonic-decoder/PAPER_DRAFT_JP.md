...
σ_eff = 8.5 dB の場合: 設計文書（06_noise-budget.md）の全損失パス通過後のBSモデル計算により V_eff = 0.1417 SNU（η = 0.914、V_sqz = 0.0501、V_nl = 0.010 SNU 込み: V_eff = 0.914×0.0501 + 0.086 + 0.010 = 0.142）。σ = √(0.1417/2) = 0.2662、p_phys = erfc(√π/(4×0.2662))/2 = 9.28×10⁻³。本研究の全シミュレーションは V_eff = 0.1417 を使用。
