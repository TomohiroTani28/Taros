...
σ_eff = 8.5 dB の場合: V_eff = 10^(−8.5/10) + V_nl = 0.1413 + 0.0004 ≈ 0.1417 SNU（V_nl = 0.010 SNU のうちスクイーズド分散に加算される実効成分。設計文書 06_noise-budget.md 準拠）。σ = √(0.1417/2) = 0.2662、p_phys = erfc(√π/(4×0.2662))/2 = 9.28×10⁻³。本研究の全シミュレーションは V_eff = 0.1417 を使用。
